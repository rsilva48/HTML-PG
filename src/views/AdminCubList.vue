  ...
  <div class="Cub">
    <div class="jumbotron jumbotron-fluid font">
      <div class="container">
        ...
        <router-link to="/admin/cub" class="btn btn-primary btn-lg" role="button">Volver</router-link>
        <router-link to="/admin/admin_cub_sul" class="btn btn-primary btn-lg" role="button">Formulario</router-link>
      </div>
    </div>
    <div class="container">
      <table class="table">
