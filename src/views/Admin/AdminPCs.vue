  ...
  <div class="PC">
    <div class="jumbotron jumbotron-fluid font">
      <div class="container">
        ...
        <router-link to="/admin/comp" class="btn btn-primary btn-lg ml-2" role="button">Volver</router-link>
        <router-link to="/admin/pc/sol" class="btn btn-primary btn-lg ml-2" role="button">Formulario</router-link>
        <div class="row-flex">
