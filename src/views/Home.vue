  ...
  <div class="home">
    <div class="jumbotron jumbotron-fluid font">
      <div class="container">
        ...
        <p
          class="lead"
        >El Centro de Recursos para el Aprendizaje y la Investigación, CRAI, se concibe como un lugar que integra talento humano, libros físicos y espacios diseñado para estudiantes, dotado de tecnología que facilita el acceso a valiosos recursos digitales.</p>
        <hr class="my-4" />
        <p
          class="lead"
