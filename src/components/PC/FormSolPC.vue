            ...
            <div class="container">
                <div v-show="currentstep == 1">
                    ...
                    <div class="input-group">
                        ...
                        <select id="ocup" v-model="pc.user.ocup" class="form-select" :disabled="pc.user.found" required>
                    ...
                    <div v-if="pc.user.ocup == 'Est'" class="input-group">
                        <label class="label">Facultad</label>
                        <select v-model="pc.user.fac" class="form-select" :disabled="pc.user.found">
                ...
                <div v-show="currentstep == 2">
                    ...
                    <div class="input-group">
                        ...
                        <br />
                        <input v-model.number="pc.check" type="checkbox" name="terminos" class="center" /> Acepto y
